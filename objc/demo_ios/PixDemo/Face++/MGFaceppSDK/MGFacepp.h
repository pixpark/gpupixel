 ...
 */
- (instancetype)initWithModel:(NSData*)modelData
                 maxFaceCount:(NSInteger)maxFaceCount
                faceppSetting:(void (^)(MGFaceppConfig* config))config;
 ...
 *  @param nr       关键点个数
 */
- (BOOL)GetGetLandmark:(MGFaceInfo*)faceInfo
...
/**
 ...
 @return 比对相似度
 */
- (float)faceCompareWithFaceInfo:(MGFaceInfo*)faceInfo
                        faceInf2:(MGFaceInfo*)faceInf2;
...
/**
 ...
 @return 相似度
 */
- (float)faceCompareWithFeatureData:(NSData*)featureData
                       featureData2:(NSData*)featureData2;
